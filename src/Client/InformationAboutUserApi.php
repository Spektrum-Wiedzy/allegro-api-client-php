...
/**
     ...
     * @throws \AllegroApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AllegroApi\Model\SmartSellerClassificationReport|\AllegroApi\Model\AuthError|\AllegroApi\Model\ErrorsHolder
     */
    public function getSellerSmartClassificationGET(string $contentType = self::contentTypes['getSellerSmartClassificationGET'][0])
    {
        list($response) = $this->getSellerSmartClassificationGETWithHttpInfo($contentType);
        return $response;
    }
     ...
     * @throws \AllegroApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AllegroApi\Model\SmartSellerClassificationReport|\AllegroApi\Model\AuthError|\AllegroApi\Model\ErrorsHolder, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSellerSmartClassificationGETWithHttpInfo(string $contentType = self::contentTypes['getSellerSmartClassificationGET'][0])
    {
        $request = $this->getSellerSmartClassificationGETRequest($contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSellerSmartClassificationGETAsync(string $contentType = self::contentTypes['getSellerSmartClassificationGET'][0])
    {
        return $this->getSellerSmartClassificationGETAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSellerSmartClassificationGETAsyncWithHttpInfo(string $contentType = self::contentTypes['getSellerSmartClassificationGET'][0])
    {
        $returnType = '\AllegroApi\Model\SmartSellerClassificationReport';
        $request = $this->getSellerSmartClassificationGETRequest($contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSellerSmartClassificationGETRequest(string $contentType = self::contentTypes['getSellerSmartClassificationGET'][0])
    {
