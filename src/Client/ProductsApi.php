...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getProductChanges'] to see the possible values for this operation
     *
     * @throws \AllegroApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \AllegroApi\Model\ProductChangesResponse|\AllegroApi\Model\ErrorsHolder|\AllegroApi\Model\AuthError
     * @deprecated
     */
    public function getProductChanges($product_id, $from = null, $to = null, string $contentType = self::contentTypes['getProductChanges'][0])
    {
        list($response) = $this->getProductChangesWithHttpInfo($product_id, $from, $to, $contentType);
        return $response;
    }
     ...
     * @throws \AllegroApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \AllegroApi\Model\ProductChangesResponse|\AllegroApi\Model\ErrorsHolder|\AllegroApi\Model\AuthError, HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
    public function getProductChangesWithHttpInfo($product_id, $from = null, $to = null, string $contentType = self::contentTypes['getProductChanges'][0])
    {
        $request = $this->getProductChangesRequest($product_id, $from, $to, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\AllegroApi\Model\ProductChangesResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\AllegroApi\Model\ProductChangesResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\AllegroApi\Model\ProductChangesResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\AllegroApi\Model\ProductChangesResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\AllegroApi\Model\ProductChangesResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function getProductChangesAsync($product_id, $from = null, $to = null, string $contentType = self::contentTypes['getProductChanges'][0])
    {
        return $this->getProductChangesAsyncWithHttpInfo($product_id, $from, $to, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function getProductChangesAsyncWithHttpInfo($product_id, $from = null, $to = null, string $contentType = self::contentTypes['getProductChanges'][0])
    {
        $returnType = '\AllegroApi\Model\ProductChangesResponse';
        $request = $this->getProductChangesRequest($product_id, $from, $to, $contentType);
     ...
     * @deprecated
     */
    public function getProductChangesRequest($product_id, $from = null, $to = null, string $contentType = self::contentTypes['getProductChanges'][0])
    {
