...
/**
     ...
     */
    public function getOfferSmartClassificationGET($offer_id, string $contentType = self::contentTypes['getOfferSmartClassificationGET'][0])
    {
        list($response) = $this->getOfferSmartClassificationGETWithHttpInfo($offer_id, $contentType);
        return $response;
    }
     ...
     */
    public function getOfferSmartClassificationGETWithHttpInfo($offer_id, string $contentType = self::contentTypes['getOfferSmartClassificationGET'][0])
    {
        $request = $this->getOfferSmartClassificationGETRequest($offer_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOfferSmartClassificationGETAsync($offer_id, string $contentType = self::contentTypes['getOfferSmartClassificationGET'][0])
    {
        return $this->getOfferSmartClassificationGETAsyncWithHttpInfo($offer_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOfferSmartClassificationGETAsyncWithHttpInfo($offer_id, string $contentType = self::contentTypes['getOfferSmartClassificationGET'][0])
    {
        $returnType = '\AllegroApi\Model\SmartOfferClassificationReport';
        $request = $this->getOfferSmartClassificationGETRequest($offer_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOfferSmartClassificationGETRequest($offer_id, string $contentType = self::contentTypes['getOfferSmartClassificationGET'][0])
    {
