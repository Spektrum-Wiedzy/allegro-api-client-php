...
/**
     ...
     */
    public function getListOfDisputesUsingGET($checkout_form_id = null, $limit = 10, $offset = 0, string $contentType = self::contentTypes['getListOfDisputesUsingGET'][0])
    {
        list($response) = $this->getListOfDisputesUsingGETWithHttpInfo($checkout_form_id, $limit, $offset, $contentType);
        return $response;
    }
     ...
     */
    public function getListOfDisputesUsingGETWithHttpInfo($checkout_form_id = null, $limit = 10, $offset = 0, string $contentType = self::contentTypes['getListOfDisputesUsingGET'][0])
    {
        $request = $this->getListOfDisputesUsingGETRequest($checkout_form_id, $limit, $offset, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getListOfDisputesUsingGETAsync($checkout_form_id = null, $limit = 10, $offset = 0, string $contentType = self::contentTypes['getListOfDisputesUsingGET'][0])
    {
        return $this->getListOfDisputesUsingGETAsyncWithHttpInfo($checkout_form_id, $limit, $offset, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getListOfDisputesUsingGETAsyncWithHttpInfo($checkout_form_id = null, $limit = 10, $offset = 0, string $contentType = self::contentTypes['getListOfDisputesUsingGET'][0])
    {
        $returnType = '\AllegroApi\Model\DisputeListResponse';
        $request = $this->getListOfDisputesUsingGETRequest($checkout_form_id, $limit, $offset, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getListOfDisputesUsingGETRequest($checkout_form_id = null, $limit = 10, $offset = 0, string $contentType = self::contentTypes['getListOfDisputesUsingGET'][0])
    {
